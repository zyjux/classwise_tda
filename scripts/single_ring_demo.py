...
ds = xr.open_dataset("~/classwise_tda/data/single_ring_synth_dataset.nc")

unified_points = ds["ring"]
...
F.savefig("/nfs/home/lverho/classwise_tda/figures/single_ring_landscape.png")
